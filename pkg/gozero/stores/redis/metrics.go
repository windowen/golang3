...
import (
	...
	metric2 "serverApi/pkg/gozero/metric"
)

const namespace = "redis_client"

var (
	metricReqDur = metric2.NewHistogramVec(&metric2.HistogramVecOpts{
		Namespace: namespace,
		Subsystem: "requests",
		Name:      "duration_ms",
	...
	metricReqErr = metric2.NewCounterVec(&metric2.CounterVecOpts{
		Namespace: namespace,
		Subsystem: "requests",
		Name:      "error_total",
	...
	metricSlowCount = metric2.NewCounterVec(&metric2.CounterVecOpts{
		Namespace: namespace,
		Subsystem: "requests",
		Name:      "slow_total",
