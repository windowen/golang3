...
import (
	...
	"serverApi/pkg/gozero/mathx"
	"serverApi/pkg/gozero/stat"
	syncx2 "serverApi/pkg/gozero/syncx"
...
var (
	...
	enabled = syncx2.ForAtomicBool(true)
	// default to be enabled
	logEnabled = syncx2.ForAtomicBool(true)
...
type (
	...
	adaptiveShedder struct {
		...
		flying          int64
		avgFlying       float64
		avgFlyingLock   syncx2.SpinLock
		overloadTime    *syncx2.AtomicDuration
		droppedRecently *syncx2.AtomicBool
...
func NewAdaptiveShedder(opts ...ShedderOption) Shedder {
	...
	return &adaptiveShedder{
		...
		overloadTime:    syncx2.NewAtomicDuration(),
		droppedRecently: syncx2.NewAtomicBool(),
